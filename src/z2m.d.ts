import type TypeEventBus from "zigbee2mqtt/dist/eventBus";
import type TypeExtension from "zigbee2mqtt/dist/extension/extension";
import type TypeDevice from "zigbee2mqtt/dist/model/device";
import type TypeGroup from "zigbee2mqtt/dist/model/group";
import type TypeMQTT from "zigbee2mqtt/dist/mqtt";
import type TypeState from "zigbee2mqtt/dist/state";
import type TypeZigbee from "zigbee2mqtt/dist/zigbee";
import type {
  AdapterTypes as ZHAdapterTypes,
  Events as ZHEvents,
  Models as ZHModels,
...
declare global {
  ...
  namespace eventdata {
    ...
    type MQTTMessagePublished = {
      topic: string;
      payload: string;
      options: { retain: boolean; qos: number };
    };
    type StateChange = {
      entity: Device | Group;
      from: KeyValue;
    ...
    type GroupMembersChanged = {
      group: Group;
      action: "remove" | "add" | "remove_all";
